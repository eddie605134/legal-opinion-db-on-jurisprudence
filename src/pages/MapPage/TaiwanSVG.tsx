...
type TaiwanLocationsKeys = keyof typeof taiwanLocations;
...
const TaiwanSVG = () => {
  ...
  const [selectArea, setSelectedArea] = useState('0');

  const handleSvgClick = (event: any) => {
    var path = document.getElementById(event.target.id);
    if (event != undefined && path!.getAttribute("values") != null) {
      setSelectedArea(path!.getAttribute("values")!);
      handleSelectMap(path!.getAttribute("values")!);
  ...
  const handleMouseEnter = (event: any) => {
    ...
    const name: TaiwanLocationsKeys = target.getAttribute('data-name');
    const rect = target.getBoundingClientRect();
    setTooltip({
      content: taiwanLocations[name],
  ...
  return (<>
    ...
    <Svg
      ...
      <Path id="penghu_country" onMouseEnter={handleMouseEnter}
        ...
        selectMapValue == '4' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="chiayi_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="chiayi_country" values='3' className={
        selectMapValue == '3' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="taichung_city" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="taichung_city" values='2' className={
        selectMapValue == '2' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path
        ...
        onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="keelung_city" values='1' className={
          selectMapValue == '1' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path
        id="pingtung_country"
        onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="pingtung_country" values='4' className={
          selectMapValue == '4' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="taipei_city" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="taipei_city" values='1' className={
        selectMapValue == '1' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path
        id="new_taipei_city"
        onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="new_taipei_city" values='1' className={
          selectMapValue == '1' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="yilan_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="yilan_country" values='1' className={
        selectMapValue == '1' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="taoyuan_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="taoyuan_country" values='1' className={
        selectMapValue == '1' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="hsinchu_city" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="hsinchu_city" values='1' className={
        selectMapValue == '1' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="hsinchu_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="hsinchu_country" values='1' className={
        selectMapValue == '1' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="miaoli_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="miaoli_country" values='2' className={
        selectMapValue == '2' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="changhua_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="changhua_country" values='2' className={
        selectMapValue == '2' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="yunlin_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="yunlin_country" values='3' className={
        selectMapValue == '3' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="hualien_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="hualien_country" values='5' className={
        selectMapValue == '5' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="nantou_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="nantou_country" values='2' className={
        selectMapValue == '2' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="taitung_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="taitung_country" values='5' className={
        selectMapValue == '5' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="tainan_city" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="tainan_city" values='3' className={
        selectMapValue == '3' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="kaohsiung_city" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="kaohsiung_city" values='4' className={
        selectMapValue == '4' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <Path id="chiayi_city" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="chiayi_city" values='3' className={
        selectMapValue == '3' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
      ...
      <g id="kinmen_country" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="kinmen_country">
        <Path id="b83ee7c9-49c5-43e6-acea-f06d1c113084" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="path2643" values='6' className={
          selectMapValue == '6' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
        ...
        <Path id="d79029f3-0676-44b4-95ba-4a92345eb565" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="path2645" values='6' className={
          selectMapValue == '6' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
        } d="M46.69,248.23,47,249l.44.63-.25.5.94.06.63.31.56-.38-.13-.44-.94-.06-.44-1.44-1.13.06h0Z" />
        <Path id="69a6ddb2-05bc-4235-b68c-837d8cf3e8ef" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="path2647" values='6' className={
          selectMapValue == '6' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
        } d="M45.75,250.81l-.44.56,1.57.38.5-.38-1.63-.56Z" />
        <Path id="095a4c54-e8f5-4120-91cf-b6c705de29ff" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="path2651" values='6' className={
          selectMapValue == '6' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
        ...
        <Path id="87972721-81c8-4058-acb3-6963aa0ed3e0" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="path2655" values='6' className={
          selectMapValue == '6' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
        } d="M107.46,220l-.75.25.31.31H108l-.5-.56h0Z" />
        <Path id="1618ff3b-8feb-42b3-b000-0d7dc2b4b993" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} data-name="path2657" values='6' className={
          selectMapValue == '6' ? 'path-click' : selectMapValue == '0' ? 'toppath-click' : ''
