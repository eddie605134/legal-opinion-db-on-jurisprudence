...
export const useSearchOpinionByKeyword = (keyword: string) => useQuery({
  ...searchSchema.getOpinionByKeyword(keyword),
  cacheTime: 0,
});
export const useSearchOpinionByOpinion = (opinion: string) => useQuery({
  ...searchSchema.getOpinionByOpinion(opinion),
  cacheTime: 0,
});
